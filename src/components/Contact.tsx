  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center pt-24 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Primary CTA - Email */}
        <div className="animate-fade-in-up mb-8 max-w-xl mx-auto" style={{ animationDelay: "300ms" }}>
          <a
          ...
          >
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-8 md:p-10">
              <div className="flex flex-col md:flex-row items-center gap-6">
                {/* Icon */}
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-blue-500/25 group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-blue-500/30 transition-all duration-300">
                  <svg
        ...
        {/* GitHub - Secondary */}
        <div className="animate-fade-in-up mb-16 max-w-xl mx-auto" style={{ animationDelay: "400ms" }}>
          <a
            href="https://github.com/ryanssareen"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-500 bg-white/50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300"
          >
            <svg
