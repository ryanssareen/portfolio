      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-sm text-foreground/60">rsareen@gmail.com</p>
          </a>
          ...
          <a
            href="https://linkedin.com/in/ryan-sareen"
            target="_blank"
            rel="noopener noreferrer"
            className="group p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-blue-600 dark:hover:border-blue-600 hover:shadow-2xl transition-all hover:-translate-y-2"
          >
            ...
            <p className="text-sm text-foreground/60">Ryan Sareen</p>
          </a>
        </div>
