...
const previews = [
  { src: "/projects/daily-athlete.png", alt: "The Daily Athlete" },
  { src: "/projects/find-me-a-race.png", alt: "Find Me a Race" },
  { src: "/projects/finance-manager.png", alt: "Finance Manager" },
  { src: "/projects/bank-brief.png", alt: "Bank Brief" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-14 items-center">
          ...
          <div className={`transition-all duration-700 delay-300 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            <div className="grid grid-cols-2 gap-3">
              {previews.map((p, i) => (
                <Link
                  key={p.alt}
                  href="/projects"
                  className="group relative rounded-xl overflow-hidden border border-slate-200/60 dark:border-white/10 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
            ...
            <div className="flex items-center justify-center gap-4 mt-4">
              ...
              <span className="w-px h-3 bg-slate-300 dark:bg-slate-700" />
              <span className="flex items-center gap-1.5 text-foreground/25 text-xs font-medium">
